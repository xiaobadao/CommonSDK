#
#  Be sure to run `pod spec lint UMFramework.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author    = "程龙"
  # spec.authors            = { "程龙" => "v-chenglong@xiaomi.com" }
  # spec.social_media_url   = "https://twitter.com/程龙"
...
spec.swift_version = "4.2"
  ...
  spec.source_files  = "TEST/UMFramwork/**"
